...
export default {
    ...
    computed: {
        ...mapGetters('DispathOrder',['CarPerfect']), 
    },
    watch:{
      CarPerfect: {
        handler: function(val) {
            if(val.reqUnitCode || val.sUnitCode){
                this.getAvailableDriver(1);
            }     
        }
      }
    },
    methods:{
        ...
        getAvailableDriver (index) {
            ...
            let params = {
                startTime:this.CarPerfect.dDepartureTime,
                reqUnitCode:this.CarPerfect.reqUnitCode?this.CarPerfect.reqUnitCode:this.CarPerfect.sUnitCode,
                autoId:autoId
            }
        ...
        determine () {
            ...
            this.$store.dispatch("DispathOrder/setChoiceDriver", Object.assign({},this.radioData)).then(() => {
